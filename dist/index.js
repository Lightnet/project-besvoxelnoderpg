...
console.log("database:" + config.blocaldatabase);

if (config.blocaldatabase) {
    //'mongodb://<dbuser>:<dbpassword>@ds139438.mlab.com:39438/rpggdb'//'localhost/my-database'
    /*
    levelDB = levelup('localhost:27017/voxel',{
        db: require('mongodown')
    });
    */
    levelDB = levelup(require('mongodown')('localhost/voxel'));
...
//gun({file: 'data.json', web: serverapp});
